...
<body>
  ...
  <!-- <div class="preview h-50 w-50 d-flex align-items-center justify-content-center">
    ...
    <form action="" method="POST" class="forma d-flex flex-column">
    <div>
        ...
        <div class="checkboxes d-flex flex-column">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                ?>
                <div>
                <input type="checkbox" value="<?php echo $row['tag_id']?>" name="tags[<?php echo $i?>][]">
        ...
        <button type="submit" name="submit" class="fixed-bottom" id="submit">Submit</button>
  ...
  <button id="addmore" class="text-center" onclick="add()">Add more</button>
    ...
    XM.open('GET', 'tags.php?theme=<?php echo $theme ?>');
    XM.send();
}
    ...
    var submit =document.querySelector('.submit').addEventListener('click' , function () {
